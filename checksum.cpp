...
bool Checksum::validateChecksum(unsigned char *buffer, int type, int dataArea, bool overwrite)
{
	...
	{
          printf("!computeChecksum(type, ptr, &computedChecksum) return false");
		return false;
	}
